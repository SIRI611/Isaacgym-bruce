...
class GazeboInterface(object):
    def __init__(self, robot_name, num_joints, num_contact_sensors=None):
        """
        Interface between Gazebo (C++) and Python using shared memory
        :param robot_name: Name of robot (as defined in the gazebo world file)
        :param num_joints: Number of joints of robot (as defined in the robot's sdf file)
        :param num_contact_sensors: number of contact sensors (as defined in the robot's sdf file)
        """
